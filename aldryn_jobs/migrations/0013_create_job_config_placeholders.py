...
def create_missing_placeholders(apps, schema_editor):
    ...
    model_to_fetch = apps.get_model('aldryn_jobs', 'JobsConfig')
    configs_qs = model_to_fetch.objects.all()
    ...
    try:
        ...
        new_model_to_fetch = get_model('aldryn_jobs.{0}'.format(
            model_to_fetch.__name__))
        with transaction.atomic():
            configs = new_model_to_fetch.objects.filter()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('aldryn_jobs', '0012_auto_20150713_0859'),
    ]
