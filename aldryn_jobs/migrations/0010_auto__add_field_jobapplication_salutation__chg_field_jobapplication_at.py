...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobApplication.salutation'
        db.add_column(u'aldryn_jobs_jobapplication', 'salutation',
                      self.gf('django.db.models.fields.CharField')(default='male', max_length=20, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'JobApplication.salutation'
        db.delete_column(u'aldryn_jobs_jobapplication', 'salutation')
