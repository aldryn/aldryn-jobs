...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'aldryn_jobs', ['JobListPlugin'])


    def backwards(self, orm):
        # Deleting model 'JobListPlugin'
        db.delete_table(u'cmsplugin_joblistplugin')
    ...
    models = {
        ...
        u'aldryn_jobs.joblistplugin': {
            'Meta': {'object_name': 'JobListPlugin', 'db_table': "u'cmsplugin_joblistplugin'", '_ormbases': ['cms.CMSPlugin']},
