...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobOfferTranslation.lead_in'
        db.add_column(u'aldryn_jobs_joboffer_translation', 'lead_in',
                      self.gf('djangocms_text_ckeditor.fields.HTMLField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobOfferTranslation.lead_in'
        db.delete_column(u'aldryn_jobs_joboffer_translation', 'lead_in')
