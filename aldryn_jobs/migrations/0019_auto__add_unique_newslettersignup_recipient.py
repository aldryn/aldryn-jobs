...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'NewsletterSignup', fields ['recipient']
        db.create_unique(u'aldryn_jobs_newslettersignup', ['recipient'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'NewsletterSignup', fields ['recipient']
        db.delete_unique(u'aldryn_jobs_newslettersignup', ['recipient'])
