...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JobNewsletterRegistrationPlugin.app_config'
        db.add_column(u'aldryn_jobs_jobnewsletterregistrationplugin', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True),
                      keep_default=False)

        # Adding unique constraint on 'JobsConfig', fields ['namespace']
        db.create_unique(u'aldryn_jobs_jobsconfig', ['namespace'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'JobNewsletterRegistrationPlugin.app_config'
        db.delete_column(u'aldryn_jobs_jobnewsletterregistrationplugin', 'app_config_id')
