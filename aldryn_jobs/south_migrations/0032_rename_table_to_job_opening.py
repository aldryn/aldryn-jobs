...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'aldryn_jobs_joboffer_translation', u'aldryn_jobs_jobopening_translation')
        db.rename_table(u'aldryn_jobs_joboffer', u'aldryn_jobs_jobopening')


    def backwards(self, orm):
        db.rename_table(u'aldryn_jobs_jobopening_translation', u'aldryn_jobs_joboffer_translation')
        db.rename_table(u'aldryn_jobs_jobopening', u'aldryn_jobs_joboffer')
    ...
    models = {
        u'aldryn_jobs.jobapplication': {
            ...
            'job_offer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['aldryn_jobs.JobOpening']"}),
        ...
        u'aldryn_jobs.joblistplugin': {
            ...
            'app_config': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['aldryn_jobs.JobsConfig']", 'null': 'True'}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'joboffers': ('sortedm2m.fields.SortedManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['aldryn_jobs.JobOpening']", 'null': 'True', 'blank': 'True'})
        },
