...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobApplicationAttachment'
        db.create_table(u'aldryn_jobs_jobapplicationattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobApplication'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'aldryn_jobs', ['JobApplicationAttachment'])


    def backwards(self, orm):
        # Deleting model 'JobApplicationAttachment'
        db.delete_table(u'aldryn_jobs_jobapplicationattachment')
    ...
    models = {
        ...
        u'aldryn_jobs.jobapplicationattachment': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['aldryn_jobs.JobApplication']"}),
