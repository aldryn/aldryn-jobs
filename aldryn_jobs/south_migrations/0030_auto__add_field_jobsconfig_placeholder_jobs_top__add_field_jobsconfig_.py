...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobsConfig.placeholder_jobs_top'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_top',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_top', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'JobsConfig.placeholder_jobs_sidebar'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_sidebar',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_sidebar', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'JobsConfig.placeholder_jobs_detail_top'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_detail_top',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_detail_top', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'JobsConfig.placeholder_jobs_detail_bottom'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_detail_bottom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_detail_bottom', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'JobsConfig.placeholder_jobs_detail_footer'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_detail_footer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_detail_footer', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'JobsConfig.placeholder_jobs_list_top'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_list_top',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_list_top', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)

        # Adding field 'JobsConfig.placeholder_jobs_list_bottom'
        db.add_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_list_bottom',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_jobs_list_bottom', null=True, to=orm['cms.Placeholder']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'JobsConfig.placeholder_jobs_top'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_top_id')

        # Deleting field 'JobsConfig.placeholder_jobs_sidebar'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_sidebar_id')

        # Deleting field 'JobsConfig.placeholder_jobs_detail_top'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_detail_top_id')

        # Deleting field 'JobsConfig.placeholder_jobs_detail_bottom'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_detail_bottom_id')

        # Deleting field 'JobsConfig.placeholder_jobs_detail_footer'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_detail_footer_id')

        # Deleting field 'JobsConfig.placeholder_jobs_list_top'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_list_top_id')

        # Deleting field 'JobsConfig.placeholder_jobs_list_bottom'
        db.delete_column(u'aldryn_jobs_jobsconfig', 'placeholder_jobs_list_bottom_id')
    ...
    models = {
        ...
        u'aldryn_jobs.jobcategory': {
            ...
            'supervisors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "u'job_offer_categories'", 'blank': 'True', 'to': u"orm['auth.User']"})
        },
        ...
        u'aldryn_jobs.joboffer': {
            'Meta': {'ordering': "[u'category__ordering', u'category', u'-created']", 'object_name': 'JobOffer'},
        ...
        u'aldryn_jobs.joboffertranslation': {
            'Meta': {'unique_together': "[[u'slug', u'language_code'], (u'language_code', u'master')]", 'object_name': 'JobOfferTranslation', 'db_table': "u'aldryn_jobs_joboffer_translation'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
