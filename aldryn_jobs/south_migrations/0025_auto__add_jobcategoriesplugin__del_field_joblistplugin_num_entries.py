...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobCategoriesPlugin'
        db.create_table(u'aldryn_jobs_jobcategoriesplugin', (
        ...
        db.send_create_signal(u'aldryn_jobs', ['JobCategoriesPlugin'])
    ...
    def backwards(self, orm):
        # Deleting model 'JobCategoriesPlugin'
        db.delete_table(u'aldryn_jobs_jobcategoriesplugin')
