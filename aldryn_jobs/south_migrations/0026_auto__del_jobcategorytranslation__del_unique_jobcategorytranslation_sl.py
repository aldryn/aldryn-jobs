...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobCategoryOpts'
        db.create_table(u'aldryn_jobs_jobcategoryopts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('aldryn_categories.fields.CategoryOneToOneField')(related_name='jobs_opts', unique=True, to=orm['aldryn_categories.Category'])),
            ('app_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True)),
        ))
        db.send_create_signal(u'aldryn_jobs', ['JobCategoryOpts'])

        # Adding M2M table for field supervisors on 'JobCategoryOpts'
        m2m_table_name = db.shorten_name(u'aldryn_jobs_jobcategoryopts_supervisors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('jobcategoryopts', models.ForeignKey(orm[u'aldryn_jobs.jobcategoryopts'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['jobcategoryopts_id', 'user_id'])

        # Adding field 'JobOffer.category_new'
        db.add_column(u'aldryn_jobs_joboffer', 'category_new',
                      self.gf('aldryn_categories.fields.CategoryForeignKey')(default=None, related_name='job_offers', null=True, to=orm['aldryn_categories.Category']),
                      keep_default=False)


        # Changing field 'JobOffer.category'
        db.alter_column(u'aldryn_jobs_joboffer', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['aldryn_jobs.JobCategory']))

    def backwards(self, orm):
        # Deleting model 'JobCategoryOpts'
        db.delete_table(u'aldryn_jobs_jobcategoryopts')

        # Removing M2M table for field supervisors on 'JobCategoryOpts'
        db.delete_table(db.shorten_name(u'aldryn_jobs_jobcategoryopts_supervisors'))

        # Deleting field 'JobOffer.category_new'
        db.delete_column(u'aldryn_jobs_joboffer', 'category_new_id')

        # Changing field 'JobOffer.category'
        db.alter_column(u'aldryn_jobs_joboffer', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['aldryn_jobs.JobCategory']))
