...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aldryn_jobs_newslettersignupuser', (
            ...
            ('signup', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_user', to=orm['aldryn_jobs.NewsletterSignup'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='newsletter_signup', to=orm['auth.User'])),
        ))
