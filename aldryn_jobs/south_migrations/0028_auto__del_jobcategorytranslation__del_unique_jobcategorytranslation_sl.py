...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'JobCategoryTranslation', fields ['language_code', u'master']
        db.delete_unique(u'aldryn_jobs_jobcategory_translation', ['language_code', u'master_id'])
        ...
        db.delete_table(u'aldryn_jobs_jobcategory_translation')

        # Deleting model 'JobCategory'
        db.delete_table(u'aldryn_jobs_jobcategory')

        # Removing M2M table for field supervisors on 'JobCategory'
        db.delete_table(db.shorten_name(u'aldryn_jobs_jobcategory_supervisors'))

        # Deleting field 'JobOffer.category'
        db.delete_column(u'aldryn_jobs_joboffer', 'category_id')

        # Rename field 'JobOffer.category_new' to 'JobOffer.category'
        db.rename_column('aldryn_jobs_joboffer', 'category_new_id', 'category_id')

    def backwards(self, orm):
        # Adding model 'JobCategoryTranslation'
        db.create_table(u'aldryn_jobs_jobcategory_translation', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['aldryn_jobs.JobCategory'])),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'aldryn_jobs', ['JobCategoryTranslation'])
        ...
        # Adding unique constraint on 'JobCategoryTranslation', fields ['language_code', u'master']
        db.create_unique(u'aldryn_jobs_jobcategory_translation', ['language_code', u'master_id'])

        # Adding model 'JobCategory'
        db.create_table(u'aldryn_jobs_jobcategory', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('app_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'aldryn_jobs', ['JobCategory'])

        # Adding M2M table for field supervisors on 'JobCategory'
        m2m_table_name = db.shorten_name(u'aldryn_jobs_jobcategory_supervisors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('jobcategory', models.ForeignKey(orm[u'aldryn_jobs.jobcategory'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['jobcategory_id', 'user_id'])

        # Rename field 'JobOffer.category' to 'JobOffer.category_new'
        db.rename_column('aldryn_jobs_joboffer', 'category_id', 'category_new_id')

        # Add old category field
        db.add_column('aldryn_jobs_joboffer', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='jobs', null=True, to=orm['aldryn_jobs.JobCategory']))
    ...
    models = {
        ...
        u'aldryn_jobs.joboffer': {
            ...
            'category': ('aldryn_categories.fields.CategoryForeignKey', [], {'related_name': "'job_offers'", 'to': u"orm['aldryn_categories.Category']"}),
