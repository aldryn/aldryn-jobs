...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobApplication.is_rejected'
        db.add_column(u'aldryn_jobs_jobapplication', 'is_rejected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'JobApplication.rejection_date'
        db.add_column(u'aldryn_jobs_jobapplication', 'rejection_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobApplication.is_rejected'
        db.delete_column(u'aldryn_jobs_jobapplication', 'is_rejected')

        # Deleting field 'JobApplication.rejection_date'
        db.delete_column(u'aldryn_jobs_jobapplication', 'rejection_date')
