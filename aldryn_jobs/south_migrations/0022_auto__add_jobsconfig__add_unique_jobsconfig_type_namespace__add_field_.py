...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobsConfig'
        db.create_table(u'aldryn_jobs_jobsconfig', (
        ...
        db.send_create_signal(u'aldryn_jobs', ['JobsConfig'])

        # Adding unique constraint on 'JobsConfig', fields ['type', 'namespace']
        db.create_unique(u'aldryn_jobs_jobsconfig', ['type', 'namespace'])

        # Adding field 'JobApplication.app_config'
        db.add_column(u'aldryn_jobs_jobapplication', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True),
                      keep_default=False)

        # Adding field 'JobOffer.app_config'
        db.add_column(u'aldryn_jobs_joboffer', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True),
                      keep_default=False)

        # Adding field 'JobCategory.app_config'
        db.add_column(u'aldryn_jobs_jobcategory', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True),
                      keep_default=False)

        # Adding field 'JobListPlugin.app_config'
        db.add_column(u'cmsplugin_joblistplugin', 'app_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_jobs.JobsConfig'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'JobsConfig'
        db.delete_table(u'aldryn_jobs_jobsconfig')

        # Deleting field 'JobApplication.app_config'
        db.delete_column(u'aldryn_jobs_jobapplication', 'app_config_id')

        # Deleting field 'JobOffer.app_config'
        db.delete_column(u'aldryn_jobs_joboffer', 'app_config_id')

        # Deleting field 'JobCategory.app_config'
        db.delete_column(u'aldryn_jobs_jobcategory', 'app_config_id')

        # Deleting field 'JobListPlugin.app_config'
        db.delete_column(u'cmsplugin_joblistplugin', 'app_config_id')
