...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'JobOpeningTranslation', fields ['slug']
        try:
            db.delete_index(u'aldryn_jobs_jobopening_translation', ['slug'])
        except:
            pass


    def backwards(self, orm):
        # Adding index on 'JobOpeningTranslation', fields ['slug']
        db.create_index(u'aldryn_jobs_jobopening_translation', ['slug'])
