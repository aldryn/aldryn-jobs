...
module.exports = function (config) {
    ...
    var settings = {
        ...
        files: [
            ...
            '../../aldryn_jobs/boilerplates/bootstrap3/static/js/libs/*.js',
            '../../aldryn_jobs/boilerplates/bootstrap3/static/js/addons/*.js',
        ...
        preprocessors: {
            '../../aldryn_jobs/boilerplates/bootstrap3/static/js/addons/*.js': ['coverage'],
            // for fixtures
            '**/*.html': ['html2js'],
            '**/*.json': ['json_fixtures']
        },
